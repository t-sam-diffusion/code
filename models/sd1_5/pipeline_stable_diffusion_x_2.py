        ...
        **kwargs,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if latent_opt_config.add_previous_attention_maps and (
                    latent_opt_config.previous_attention_map_anchor_step is None
                    or i == latent_opt_config.previous_attention_map_anchor_step
                ):
